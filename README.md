...
- `/todos/` - Список задач (с вложенными списками и карточками)
- `/todos/<id>/` - Детали задачи (карточка объекта)
- `/todos/console/` - Вывод данных в консоль Django
- `/todos/browser/` - Просмотр данных в браузере (старая версия)
...
│   ├── todos_list.html    # Список задач
│   └── todo_detail.html   # Детали задачи
...
- ✅ HTML шаблоны с навбаром и футером
- ✅ Сортированный список с вложенными элементами
- ✅ Карточки объектов
- ✅ Адаптивный дизайн
- ✅ Правильное подключение статических файлов (CSS + JS)
